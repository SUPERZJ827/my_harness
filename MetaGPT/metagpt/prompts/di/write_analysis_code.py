...
your code
```
The code block must be complete and closed. Keep the implementation compact enough to fit in one response.
"""
...
[instruction]
Analyze your previous code and error in [context], then provide the improved implementation. Remember to follow [context] requirement. Don't forget to write code for steps behind the error step.
Output one and only one complete Python code block. Do not wrap the code in JSON.
```python
your improved code
```
"""
